...
RegisterNUICallback('getPlayerData', function(data, cb)
  if CurrentFramework == "esx" then
    ESX.TriggerServerCallback('raysist_documents:getPlayerData', function(result)
      cb(result)
    end)
  elseif CurrentFramework == "qb" then
...
RegisterNUICallback('getPlayerCopies', function(data, cb)
  TriggerCallback('raysist_documents:getPlayerCopies', function(result)
    cb(result)
  end)
end)

RegisterNUICallback('getIssuedDocuments', function(data, cb)
  TriggerCallback('raysist_documents:getPlayerDocuments', function(result)
    cb(result)
  end)
end)

RegisterNUICallback('createDocument', function(data, cb)
  TriggerCallback('raysist_documents:createDocument',function(result)
    cb(result)
  end,
  data)
end)
...
RegisterNUICallback('createTemplate', function(data, cb)
  TriggerCallback('raysist_documents:createTemplate',function(result)
    cb(result)
  end,
  data)
end)
...
RegisterNUICallback('editTemplate', function(data, cb)
  TriggerCallback('raysist_documents:editTemplate',function(result)
    cb(result)
  end,
  data)
end)
...
RegisterNUICallback('deleteTemplate', function(data, cb)
  TriggerCallback('raysist_documents:deleteTemplate',function(result)
    cb(result)
  end,
  data)
end)
...
RegisterNUICallback('deleteDocument', function(data, cb)
  TriggerCallback('raysist_documents:deleteDocument',function(result)
    cb(result)
  end,
  data)
end)
...
RegisterNUICallback('getMyTemplates', function(data, cb)
  TriggerCallback('raysist_documents:getDocumentTemplates', function(result)
    cb(result)
  end)
end)
...
RegisterNUICallback('giveCopy', function(data, cb)
  Citizen.CreateThread(function()
    ...
    if targetId == -1 then
      ...
      TriggerServerEvent("raysist_documents:giveCopy", data, targetId)
    end
  end)
end)
...
RegisterNUICallback('showDocument', function(data, cb)
  Citizen.CreateThread(function()
    ...
    if targetId == -1 then
      ...
      TriggerServerEvent("raysist_documents:receiveDocument", data, targetId)
    end
  end)
end)

RegisterNetEvent('raysist_documents:copyGave')
AddEventHandler('raysist_documents:copyGave', function(data)
	holdDocument(false)
  playAnim("mp_common", "givetake1_a", 1500)
  Notification(Config.Locale.giveNotification .. " " .. data)
end)

RegisterNetEvent("raysist_documents:useItem")
AddEventHandler("raysist_documents:useItem", function()
	toggleNuiFrame(true, true)
end)


RegisterNetEvent('raysist_documents:copyReceived')
AddEventHandler('raysist_documents:copyReceived', function(data)
  Notification(Config.Locale.receiveNotification .. " " .. data)
end)

RegisterNetEvent('raysist_documents:viewDocument')
AddEventHandler('raysist_documents:viewDocument', function(data)
